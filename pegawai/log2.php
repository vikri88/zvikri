<?php 
	...
	$sql =  "SELECT * FROM user_log INNER JOIN pegawai ON user_log.id=pegawai.id ORDER BY user_log.id_log DESC";
	 ...
	 <div class="a">
	 	<center>
		 	<div class="log">
                ...
                <div class="pagination" style="float: left; margin-left: 15px; margin-top: 5px;">
