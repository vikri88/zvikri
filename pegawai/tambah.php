...
<div class="a">
 ...
 <center>
	<div class="tambah">
		...
		<div id="London" class="w3-container city" style="display:none;">
		    ...
		    <h3>Tambah Barang</h3>
		    <br>
            <table border="0" style="width:90%; float: left; margin-left: 20px;">
                <tr>
		...
		<div id="Paris" class="w3-container city" style="display:block">
		    <form method="POST" class="form2">
		    	...
		    	<table border="1">
		    		...
		    		<tr>
		    			<td><p>Tanggal</p></td>
		    			<td><input type="text" name="tanggal" value="<?php echo date("d-M-Y"); ?>" readonly></td>
		    		</tr>
		    		<tr>
		    			<td><p>Suplier</p></td>
		    			<td>
 ...
 <?php 
	...
	if(isset($_POST['tambah'])){
		...
		$queri = mysql_query("SELECT * FROM barang_detail where no_seri = '$seri' ")or die(mysql_error());
