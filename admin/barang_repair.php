 ...
 <?php 
  ...
  ?>
	 <div class="a">
	 			...
	 			<?php
                    ...
                    <tr>
                        ...
                        <?php } else { ?>
                         ...
                         <?php }
 				 		echo "<td width='19%'><a href='selesai_repair.php?id=". $data['id'] ."'><button id='plus' onclick='return konfirmasi()'>Selesai repair</button></a>";
                         ?>
                    </tr>
                    <?php
                        $i++; 
        ...
        <a href="laporan_barang_repair.php"><button>Print</button></a>
     </div>
  <?php 
	 	include 'sisi.php';
	  ?>
