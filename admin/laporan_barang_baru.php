...
$pdf->Cell(0,5,$judul,'0','1','C');
$judul2 = "Laporan Barang Baru dan Selesai Repair";
...
$ya = $yi + $row;
$sql = mysql_query("SELECT * FROM barang INNER JOIN jenis_brg ON barang.id_jenis=jenis_brg.id_jenis WHERE status_brg='baru' OR status_brg='selesai repair' ORDER BY barang.id DESC limit 0,35");
$i = 1;
$no = 1;
$max = 31;
$row = 6;
